...
public class SponsorAskActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupUI(findViewById(R.id.layout_sponsorask));
        ...
        toolbar_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (et_title.getText().length() == 0 || et_title.getText() == null) {
                    Toast.makeText(SponsorAskActivity.this, "请填写标题", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (et_title.getText().length() > 14) {
                    Toast.makeText(SponsorAskActivity.this, "标题超过字数限制", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (et_content.getText().length() > 100) {
                    Toast.makeText(SponsorAskActivity.this, "描述超过字数限制", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (et_coin.getText().length() == 0 || et_coin.getText() == null) {
                    Toast.makeText(SponsorAskActivity.this, "请填写悬赏爱心币", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (!uploading)
                    AskLaunch();
...
//                    Toast.makeText(SponsorAskActivity.this, str, Toast.LENGTH_SHORT).show();
                    try {
                        ...
                        if (jsonObject.getString("status").equals("200")) {
                            ...
                            Toast.makeText(SponsorAskActivity.this, "发送成功", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(SponsorAskActivity.this, SquareActivity.class);
                            startActivity(intent);
                            finish();
                        } else {
                            Toast.makeText(SponsorAskActivity.this, "提问失败", Toast.LENGTH_SHORT).show();
                        }
    ...
    public void setupUI(View view) {
        ...
        if (!(view instanceof EditText)) {
            view.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    hideSoftKeyboard(SponsorAskActivity.this);
                    return false;
                }
            });
        }
