...
public class Fragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_lbf1, container, false);//关联布局文件
    ...
    private void loadData() {
        ...
        String location = "/android/lovingbank/get_exchange_coin_record";
                ...
                if (content != null) {
                    ...
                    try {
                        ...
                        if (jsonObject.getString("status").equals("200")) {
                            JSONArray jsonArray = jsonObject.getJSONArray("exchange_record");
                            for (int i = 0; i < jsonArray.length(); i++) {
                                HashMap<String, Object> listItem = new HashMap<String, Object>();
                                listItem.put("name",jsonArray.getJSONObject(i).getString("nickname"));
